...
**** header
#+begin_src emacs-lisp
;; me-ui.el --- UI enhancements -*- lexical-binding: t; -*-
<<logo>>
;;; Commentary:
;;; Code:
#+end_src
...
*** me-dashboard.el
:properties:
:header-args: :tangle modules/me-dashboard.el :noweb yes :mkdirp yes
:end:
**** header
#+begin_src emacs-lisp
...
(use-package dashboard
  ...
  (dashboard-startup-banner (concat ematrix-assets-dir "banner.txt"))
  :config
